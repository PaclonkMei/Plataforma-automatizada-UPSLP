"""
Django settings for plataforma_academica project.
...
SECRET_KEY = 'django-insecure-b#9o4nuf)g)(9!bhct%(j=v75d&z9+)i@&8m2z!ss2cme63*-n'
...
ROOT_URLCONF = 'plataforma_academica.urls'
...
WSGI_APPLICATION = 'plataforma_academica.wsgi.application'
